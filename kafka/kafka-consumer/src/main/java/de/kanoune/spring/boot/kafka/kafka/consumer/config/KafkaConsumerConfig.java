package de.kanoune.spring.boot.kafka.kafka.consumer.config;

import de.kanoune.spring.boot.kafka.app.config.data.config.KafkaConfigData;
import de.kanoune.spring.boot.kafka.app.config.data.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig <K extends Serializable,V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(kafkaConsumerConfigData.getSpecificAvroReaderKey(), kafkaConsumerConfigData.getSpecificAvroReaderValue());
